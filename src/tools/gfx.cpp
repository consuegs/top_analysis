...
std::pair<TString,TString> gfx::parseTitle(TString const &title)
{
   ...
   std::vector<std::tuple<TString,TString,TString>> repl={
      ...
      ,std::make_tuple("%pTl1","Leading lepton p_{#scale[.8]{T}}","GeV")
      ,std::make_tuple("%pTl2","p_{#scale[.8]{T}}^{#scale[.8]{l_{2}}}","GeV")
      ,std::make_tuple("%pTle","p_{#scale[.8]{T}}^{#scale[.8]{e}}","GeV")
      ,std::make_tuple("%pTlmu","p_{#scale[.8]{T}}^{#scale[.8]{#mu}}","GeV")
      ...
      ,std::make_tuple("DNN_MET_pT","p_{#scale[.8]{T,DNN}}^{#scale[.8]{miss}}","")
      ,std::make_tuple("DNN_MET_dPhi_nextLep","min[#Delta#phi(p_{#scale[.8]{T,DNN}}^{#scale[.8]{miss}},l)]","")
      ,std::make_tuple("p_{T}^{Jet1} (GeV)","Leading jet p_{#scale[.8]{T}}","GeV")
      ...
      ,std::make_tuple("2d_MetVSdPhiMetNearLep_DNN","p_{#scale[.8]{T,DNN}}^{#scale[.8]{miss}}","")
   };
