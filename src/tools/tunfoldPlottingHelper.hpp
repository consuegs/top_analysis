...
namespace tunfoldplotting
{
   ...
   std::vector<double> plot_UnfoldedResult(TUnfoldBinning* generatorBinning, TH1F* unfolded, TH1F* unfolded_reg, TH1F* unfolded_bbb,
                            ...
                            io::RootFileSaver* saver, int &num_bins, const bool rewStudy, const bool onlyTheo, const bool plotTheo, const bool divideBinWidth=true, const bool adaptYaxis=true);
