...
void run()
{
   ...
   for (distrUnfold &dist : vecDistr){
      ...
      plot_UnfoldedResult(&generatorBinning,&unfolded,&unfolded_reg,&unfolded_bbb,unfolded_total,unfolded_reg_total,unfolded_bbb_total,-1.,&realDis,&realDisAlt,dist,true,"CombinedResults_Compare",&saver,num_bins,false,false,false);
      plot_UnfoldedResult(&generatorBinning,&unfolded,&unfolded_reg,&unfolded_bbb,unfolded_total,unfolded_reg_total,unfolded_bbb_total,-1.,&realDis,&realDisAlt,dist,false,"CombinedResults_reg",&saver,num_bins,false,false,false,false,false);
