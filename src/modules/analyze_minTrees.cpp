...
hist::Histograms<TH1F> defineHistograms(std::vector<TString> const &datasets){
   ...
   for(TString channel:{"/ee","/mumu","/emu"}){
         ...
         hs.addHist(channel+"/Jet2_E"                       ,";E^{jet2} (GeV) ;EventsBIN"                            ,50,0,3.2);
         hs.addHist(channel+"/dPhiMETnearJet"               ,";|#delta#phi(PF MET, near. jet)| ;EventsBIN"           ,50,0,3.2);
         hs.addHist(channel+"/dPhiMETfarJet"                ,";|#delta#phi(PF MET, far. jet)| ;EventsBIN"            ,50,0,3.2);
         hs.addHist(channel+"/dPhiMETleadJet"               ,";|#delta#phi(PF MET, lead jet)| ;EventsBIN"            ,50,0,3.2);
         hs.addHist(channel+"/dPhiMETlead2Jet"              ,";|#delta#phi(PF MET, sublead jet)| ;EventsBIN"         ,50,0,3.2);
         hs.addHist(channel+"/dPhiMETbJet"                  ,";|#delta#phi(PF MET, lead b jet)| ;EventsBIN"          ,50,0,3.2);
         hs.addHist(channel+"/dPhiLep1Lep2"                 ,";|#delta#phi(lep1, lep2)| ;EventsBIN"                  ,50,0,3.2);
         hs.addHist(channel+"/dPhiJet1Jet2"                 ,";|#delta#phi(jet1, jet2)| ;EventsBIN"                  ,50,0,3.2);
         hs.addHist(channel+"/METsig"                       ,";PF MET sig. ;EventsBIN"                               ,50,0,200);
         hs.addHist(channel+"/MHT"                          ,";M_{HT} (GeV);EventsBIN"                               ,50,0,2000);
         hs.addHist(channel+"/MT"                           ,";M_{T} (GeV);EventsBIN"                                ,50,0,1000);
         hs.addHist(channel+"/looseLeptonVeto"              ,";looseLeptonVeto ;EventsBIN"                           ,2,-0.5,1.5);
         hs.addHist(channel+"/dPhiMETnearJet_Puppi"         ,";|#delta#phi(Puppi MET, near. jet)| ;EventsBIN"        ,50,0,3.2);
         hs.addHist(channel+"/dPhiMETfarJet_Puppi"          ,";|#delta#phi(Puppi MET, far. jet)| ;EventsBIN"         ,50,0,3.2);
         hs.addHist(channel+"/dPhiMETleadJet_Puppi"         ,";|#delta#phi(Puppi MET, lead jet)| ;EventsBIN"         ,50,0,3.2);
         hs.addHist(channel+"/dPhiMETlead2Jet_Puppi"        ,";|#delta#phi(Puppi MET, sublead jet)| ;EventsBIN"      ,50,0,3.2);
         hs.addHist(channel+"/dPhiMETbJet_Puppi"            ,";|#delta#phi(Puppi MET, lead b jet)| ;EventsBIN"       ,50,0,3.2);
         hs.addHist(channel+"/dPhiLep1bJet"                 ,";|#delta#phi(lep1, lead b jet)| ;EventsBIN"            ,50,0,3.2);
         hs.addHist(channel+"/dPhiLep1Jet1"                 ,";|#delta#phi(lep1, ljet1)| ;EventsBIN"                 ,50,0,3.2);
         hs.addHist(channel+"/mLL"                          ,";m_{ll} (GeV) ;EventsBIN"                              ,50,0,3.2);
         ...
         hs.addHist(channel+"/mjj"                          ,";m_{jj} (GeV);EventsBIN"                               ,50,0,2000);
      }
